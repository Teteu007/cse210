...
class Program
{
    ...
    {
        Address address = new Address("Unicamp", "Sao Paulo", "Campinas", "Brazil");
        ...
        Address addressR = new Address("Botafogo", "Roda do Pagode", "Rio de Janeiro", "Brazil");
        ...
        Address addressOG = new Address("Parque do Taquaral", "Campinas", "Sao Paulo", "Brazil");
